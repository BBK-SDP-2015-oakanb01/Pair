...
public class Game {
    ...
    private static final long SLEEP_INTERVAL = 11; //in milliseconds     
    ...
    public static void main(String[] args) {
        ...
        //testing Initialisation of children
        //GameTest test = new GameTest();
        //test.testInitializeChildren();
        
        //testing create game board method
        //GameTest test = new GameTest();
        //test.testGameTree();
        ...
        while (!isGameOver()) {
            ...
            while (!moveIsSafe) {
                ...
                if (bestMoves.length == 0) {
                	...
                	///always equals the first in the array
